...
def run_experiment_inter(
    ...
    for alpha in alphas:
        results = Parallel(n_jobs=n_jobs)(
            ...
            for src_index, trg_index in rs.split(range(n_subjects)))
        ...
        df.to_csv(os.path.join(
            write_dir, 'results_{}_{}_{}_{}_{}_naturalistic.csv').format
...
for system in range(len(systems)):
    ...
    run_experiment_inter(X_train_mask, X_test_mask, alphas, 
